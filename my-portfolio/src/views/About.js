				...
				<div className="container mx-auto">
					<div className="p-4">
						<Card>
							...
							<p className="mb-4 text-sm md:text-base">
								I started my journey in materials engineering, but I soon
								realized my true passion was programming. For the past four
								years, I've been working as a frontend developer, specializing
								in creating user-friendly web interfaces.
							</p>
							...
							<p className="mb-4 text-sm md:text-base">
								...
								passion for crafting impactful digital experiences. I'm excited
								to keep pushing boundaries and creating meaningful solutions in
